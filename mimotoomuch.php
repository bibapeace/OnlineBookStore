...
section{
	position: relative;
	min-height: 100vh;
	background-image: url(mimoback.jpg);
	...
	<section>
		<div class="container">
			<div class="user signinBx">
				<div class="imgBx"><img src="images/mimo.jpg"></div>
				<div class="formBx">
					<form action="forgotfunc.php" method="post" id="logform">
						<h2>Mimo too much</h2>
						<p style="text-align:center;" class="signup"><a href="registerpage.html">RETURN</a></p>
					</form>
				</div>
			</div>
	</section>

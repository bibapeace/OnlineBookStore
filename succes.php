	...
	<section>
		<div class="container">
			<div class="user signinBx">
				<div class="imgBx"><img src="images/completed.jpg"></div>
				<div class="formBx">
					<form action="forgotfunc.php" method="post" id="logform">
						<h1 style="text-align: center; font-size: 25px;">Your password has been successfully changed</h1><br>
						<p style="text-align: center;" class="singup"><a style="font-size: 18px;" href="registerpage.html">Return register page</a></p>
					</form>
				</div>
			</div>
	</section>
